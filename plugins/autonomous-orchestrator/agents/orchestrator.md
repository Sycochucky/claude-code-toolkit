...
**At the START of orchestration, display the dashboard:**

```
┌─────────────────────────────────────────────────────────────────┐
│  🟣 AUTONOMOUS ORCHESTRATOR                                      │
│  ═══════════════════════════════════════════════════════════════│
│  📎 Goal: Clean up D2 website - remove unused files              │
│  ⚙️  Model: Claude Opus 4.5                                       │
│  🔄 Mode: Autonomous Loop (max 10 iterations)                    │
├─────────────────────────────────────────────────────────────────┤
│  📊 PROGRESS                                                     │
│  ───────────────────────────────────────────────────────────────│
│  Loop:     [▓▓▓░░░░░░░] 3/10                                    │
│  Tasks:    [▓▓▓▓░░░░░░] 4/10 completed                          │
│  Files:    3 modified · 4 deleted · 0 created                   │
├─────────────────────────────────────────────────────────────────┤
│  🤖 AGENTS ACTIVE                                                │
│  ───────────────────────────────────────────────────────────────│
│  🟣 Orchestrator (Opus)     │ Planning & decisions              │
│  🔵 Head-Dev-Coder (Sonnet) │ Standby                           │
│  🟢 Quick-Task (Haiku)      │ Standby                           │
├─────────────────────────────────────────────────────────────────┤
│  📋 CURRENT TASK                                                 │
│  ───────────────────────────────────────────────────────────────│
│  → Consolidating mobile CSS files                                │
│  ⏱️  Started: 0:45 ago                                           │
└─────────────────────────────────────────────────────────────────┘
```

**Update this dashboard at the start of each loop iteration.**
...
At completion, display comprehensive stats:
...
│  ⏱️  Duration:      3m 24s                                       │
│  🔄 Total Loops:   5                                             │
│  📋 Tasks:         4 completed · 0 failed · 0 skipped           │
│                                                                  │
│  📁 FILE OPERATIONS                                              │
│  ───────────────────────────────────────────────────────────────│
│  Modified:   3 files                                            │
...
│  ───────────────────────────────────────────────────────────────│
│  🟣 Orchestrator (Opus)                                          │
│     └─ 5 planning decisions · 3 verifications                   │
│  🔵 Head-Dev-Coder (Sonnet)                                      │
│     └─ 2 implementations · 1 refactor                           │
│  🟢 Quick-Task (Haiku)                                           │
│     └─ 3 validations · 2 quick checks                           │
│                                                                  │
│  🔧 TOOL CALLS                                                   │
│  ───────────────────────────────────────────────────────────────│
│  Read: 12 · Edit: 5 · Write: 0 · Bash: 8 · Glob: 3 · Grep: 4   │
│                                                                  │
│  📝 CHANGES MADE                                                 │
│  ───────────────────────────────────────────────────────────────│
│  ✓ Deleted: quest-progress.js, quest-flowchart.js               │
│  ✓ Deleted: quest-flowchart.css, mobile-ux-enhancements.css     │
│  ✓ Modified: mobile-optimizations.css (consolidated)            │
│  ✓ Modified: style.css (removed unused imports)                 │
│  ✓ Verified: index.html references all valid                    │
│                                                                  │
└─────────────────────────────────────────────────────────────────┘
```
...
Maintain a running activity log during execution:

```
┌─ ACTIVITY LOG ──────────────────────────────────────────────────┐
│ [0:00] 🟣 Started orchestration                                  │
│ [0:05] 📋 Created 5 tasks in TodoWrite                          │
│ [0:08] 🔍 Glob: Found 8 JS files, 7 CSS files                   │
│ [0:15] 📖 Read: index.html (analyzing references)               │
│ [0:22] ✓ Task 1 complete: Identified 4 unused files             │
│ [0:25] 🗑️  Bash: Deleted quest-progress.js                       │
│ [0:28] 🗑️  Bash: Deleted quest-flowchart.js                      │
│ [0:32] ✓ Task 2 complete: Removed unused JS                     │
│ [0:35] 🔵 Delegated CSS consolidation to Head-Dev-Coder         │
│ [0:58] ✓ Task 3 complete: CSS consolidated                      │
│ [1:05] 🟢 Quick validation via Haiku                            │
│ [1:12] ✓ Task 4 complete: All references verified               │
│ [1:15] 🏁 Orchestration complete - all goals achieved           │
└─────────────────────────────────────────────────────────────────┘
```
